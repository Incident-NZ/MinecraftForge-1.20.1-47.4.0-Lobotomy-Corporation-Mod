...
public class PBulletExp extends Projectile {
    ...
    public PBulletExp(EntityType<? extends PBulletExp> type, Level level) {
        super(type, level);
        this.setNoGravity(true);
    }

    public PBulletExp(Level level, LivingEntity shooter, float damage, float velocity, Vec3 direction) {
