...
public class EGOHeavenP extends ThrowableItemProjectile {
    ...
    public EGOHeavenP(EntityType<? extends EGOHeavenP> type, Level level) {
        super(type, level);
        setNoGravity(true);
    }

    public EGOHeavenP(Level level, LivingEntity owner, Vec3 direction) {
