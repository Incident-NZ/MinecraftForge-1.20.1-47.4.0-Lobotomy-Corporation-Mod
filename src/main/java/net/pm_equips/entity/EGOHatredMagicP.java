...
public class EGOHatredMagicP extends Projectile implements GeoEntity {
    ...
    public EGOHatredMagicP(EntityType<? extends EGOHatredMagicP> type, Level level) {
        super(type, level);
        setNoGravity(true);
    }

    public EGOHatredMagicP(Level level, LivingEntity shooter) {
