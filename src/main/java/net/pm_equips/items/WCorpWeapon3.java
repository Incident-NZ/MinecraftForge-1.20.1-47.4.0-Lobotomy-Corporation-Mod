...
public class WCorpWeapon3 extends SwordItem {
    public static final int MAX_FE = 5000;
    public static final int FE_PER_HIT = 200;

    public WCorpWeapon3() {
        super(new CustomTier(), 9, -2.8f, new Properties());
    }
    ...
    public InteractionResultHolder<ItemStack> use(
        ...
        return WCorpTeleport.useTeleport(level, player, hand, this, FE_PER_HIT);
    }
